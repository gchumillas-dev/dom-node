...
A library for manipulating and traversing XML documents in an easy and intuitive way. This library is inspired by the [jQuery](https://jquery.com/) library and borrows some interesting ideas, like chaining.
